---
title: 'Capítulo 3: Tu primer juego 2D'
description: 'Capítulo 3: Tu primer juego 2D'
sidebar:
  order: 3
  hidden: false
---
...
![dodge-preview](/godot/img/dodge_preview.webp)
...
![new-project-button](/godot/img/new-project-button.webp)
...
![folder-content](/godot/img/folder-content.webp)
...
![setting-project-width-and-height](/godot/img/setting-project-width-and-height.webp)
...
![setting-stretch-mode](/godot/img/setting-stretch-mode.webp)
...
![filesystem-dock](/godot/img/filesystem_dock.webp)
...
![no-shape-warning](/godot/img/no_shape_warning.webp)
...
![lock-children](/godot/img/lock_children.webp)
...
![new-spriteframes](/godot/img/new_spriteframes.webp)

Haga clic en el campo `SpriteFrames` que acaba de crear para abrir el panel **SpriteFrames**:

![spriteframes-panel](/godot/img/spriteframes_panel.webp)
...
![spriteframes-panel2](/godot/img/spriteframes_panel2.webp)
...
![player-scale](/godot/img/player_scale.webp)
...
![player-coll-shape](/godot/img/player_coll_shape.webp)

Cuando hayas terminado, tu escena del jugador debería verse así:

![player-scene-nodes](/godot/img/player_scene_nodes.webp)
...
![add-script-button](/godot/img/add_script_button.webp)
...
![attach-node-window](/godot/img/attach_node_window.webp)
...
>
> ![build-dotnet](/godot/img/build_dotnet.webp)

![export-variable](/godot/img/export_variable.webp)
...
![input-mapping-add-action](/godot/img/input-mapping-add-action.webp)
...
![input-mapping-add-key](/godot/img/input-mapping-add-key.webp)
...
![input-mapping-event-configuration](/godot/img/input-mapping-event-configuration.webp)
...
![input-mapping-completed](/godot/img/input-mapping-completed.webp)
...
![player-signals](/godot/img/player_signals.webp)
...
![player-signal-connection](/godot/img/player_signal_connection.webp)
...
![set-collision-mask](/godot/img/set_collision_mask.webp)
...
![mob_animations](/godot/img/mob_animations.webp)
...
![instance-scene](/godot/img/instance_scene.webp)
...
![path2d-buttons](/godot/img/path2d_buttons.webp)
...
![grid-snap-button](/godot/img/grid_snap_button.webp)
...
![main-scene-nodes](/godot/img/main_scene_nodes.webp)
...
![custom-font-load-font](/godot/img/custom_font_load_font.webp)
...
![custom-font-size](/godot/img/custom_font_size.webp)
...
![ui-anchor](/godot/img/ui_anchor.webp)
...
![completed-main-scene](/godot/img/completed_main_scene.webp)
...
![group-tab](/godot/img/group_tab.webp)

Nombra el grupo `mobs` y haz clic en **Ok** para agregar un nuevo grupo de escena.

![add-group-dialog](/godot/img/add_group_dialog.webp)

Ahora todos los _mobs_ estarán en el grupo `mobs`.

![scene-group-mobs](/godot/img/scene_group_mobs.webp)
...
![unique-resource-music](/godot/img/unique_resource_music.webp)
...
![input-mapping-start_game](/godot/img/input-mapping-start_game.webp)
...
![start-button-shortcut](/godot/img/start_button_shortcut.webp)
...
![start-button-shortcut2](/godot/img/start_button_shortcut2.webp)
