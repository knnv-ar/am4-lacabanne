...
description: 'Capítulo 2: Primeros pasos'
sidebar:
  order: 2
  hidden: false
---
...
![godot-nodos-escenas](/godot/img/nodes_and_scenes_nodes.webp)
...
![godot-character](/godot/img/nodes_and_scenes_character_nodes.webp)
...
![godot-3d-scene-example](/godot/img/nodes_and_scenes_3d_scene_example.webp)
...
![godot-project-manager](/godot/img/godot-project-manager.png)
...
![godot-project-manager-02](/godot/img/editor_ui_intro_project_manager_04.webp)

Después de abrir el proyecto, deberías ver un editor vacío:

![godot-empy-editor](/godot/img/nodes_and_scenes_01_empty_editor.webp)
...
![godot-add-child-node](/godot/img/nodes_and_scenes_02_scene_dock.webp)

Se abre el cuadro de diálogo `Create New Node`, que muestra la larga lista de nodos disponibles:

![godot-create-new-node](/godot/img/nodes_and_scenes_03_create_node_window.webp)
...
![godot-label-node](/godot/img/nodes_and_scenes_04_create_label_window.webp)
...
![godot-label-node-in-editor](/godot/img/nodes_and_scenes_05_editor_with_label.webp)
...
![godot-label-node-in-editor](/godot/img/nodes_and_scenes_06_label_text.webp)
...
![godot-move-tool](/godot/img/nodes_and_scenes_07_move_tool.webp)
...
![godot-move-label-scene](/godot/img/nodes_and_scenes_08_hello_world_text.webp)
...
![godot-move-play-scene](/godot/img/nodes_and_scenes_09_play_scene_button.webp)
...
![godot-move-save-scene](/godot/img/nodes_and_scenes_10_save_scene_as.webp)
...
![godot-hello-world](/godot/img/nodes_and_scenes_11_final_result.webp)
...
![godot-ball](/godot/img/instancing_ball_scene.webp)
...
![godot-ball-instance](/godot/img/instancing_ball_instances_example.webp)
...
2. En el `Project Manager`, haz clic en el botón `Import` para importar el proyecto.
    ...
    ![godot-import](/godot/img/instancing_import_button.webp)
...
3. En la ventana emergente que aparece, navega hasta la carpeta que extrajiste. Haz doble clic en el archivo `project.godot` para abrirlo.
    ...
    ![godot-project-file](/godot/img/instancing_import_project_file.webp)
...
4. Por último, haz clic en el botón `Import & Edit`. Puede aparecer una ventana que le notifique que el proyecto se abrió por última vez en una versión anterior de Godot, pero no es un problema. Haga clic en el botón `Ok` para abrir el proyecto.
    ...
    ![godot-import-edit](/godot/img/instancing_import_and_edit_button.webp)
...
5. El proyecto contiene dos **escenas empaquetadas**: `main.tscn`, que contiene las paredes contra las que choca la pelota, y `ball.tscn`. La escena principal debería abrirse automáticamente. Si ve una escena 3D vacía en lugar de la escena principal, haga clic en el botón `2D` en la parte superior de la pantalla.
    ...
    ![godot-2D-scene](/godot/img/instancing_2d_scene_select.webp)

    ![godot-main-scene](/godot/img/instancing_main_scene.webp)
...
6. Agreguemos una pelota como nodo **Child** del nodo principal. En el panel de escenas, seleccione el nodo `Main`. Luego, haga clic en el ícono de vínculo en la parte superior del panel de **Scene**. Este botón le permite agregar una instancia de una escena como nodo **Child** del nodo seleccionado actualmente.
    ...
    ![godot-scene-link](/godot/img/instancing_scene_link_button.webp)

7. Haz doble clic en la escena `Ball.tscn` para crear una instancia de ella.

    ![godot-instance-child](/godot/img/instancing_instance_child_window.webp)

8. La pelota aparece en la esquina superior izquierda del _viewport_.

    ![godot-ball-instanced](/godot/img/instancing_ball_instanced.webp)

9. Haz clic en la pelota y arrástrala hacia el centro de la vista.

    ![godot-ball-moved](/godot/img/instancing_ball_moved.webp)
...
11. Ahora, queremos crear más instancias del nodo Pelota. Con la pelota aún seleccionada, presiona `Ctrl + D` (`Cmd + D` en macOS) para ejecutar el comando de duplicar. Haz clic y arrastra para mover la nueva pelota a una ubicación diferente.
    ...
    ![godot-ball-duplicated](/godot/img/instancing_ball_duplicated.webp)

12. Puedes repetir este proceso hasta que tengas varias en la escena.

    ![godot-ball-multiplicated](/godot/img/instancing_main_scene_with_balls.webp)
...
![godot-main-scene](/godot/img/instancing_scene_tabs.webp)

Selecciona uno de los nodos de bola instanciados y, en el `Inspector`, establece el valor de **Gravity Scale** en `10`.

![godot-gravity-scale](/godot/img/instancing_property_gravity_scale.webp)

Aparece un botón gris "revertir" junto a la propiedad ajustada.

![godot-revert-icon](/godot/img/instancing_property_revert_icon.webp)
...
![godot-shooter-diagram](/godot/img/instancing_diagram_shooter.webp)
...
![godot-open-world-diagram](/godot/img/instancing_diagram_open_world.webp)
...
![godot-scripting-camera-shake](/godot/img/scripting_camera_shake.gif)
...
![godot-gdscripting](/godot/img/scripting_gdscript.webp)
...
![godot-scripting-csharp](/godot/img/scripting_csharp.webp)
...
![godot-scripting-cpp](/godot/img/scripting_cpp.webp)
...
![godot-scripting-cpp](/godot/img/scripting_first_script_rotating_godot.webp)
...
![godot-other-node](/godot/img/scripting_first_script_click_other_node.webp)

Escriba "Sprite2D" en la barra de búsqueda para filtrar los nodos y haga doble clic en `Sprite2D` para crear el nodo.

![godot-sprite-node](/godot/img/scripting_first_script_add_sprite_node.webp)

Su pestaña `Scene` ahora solo debe tener un nodo Sprite2D.

![godot-sprite2D-node](/godot/img/scripting_first_script_scene_tree.webp)
...
![godot-texture](/godot/img/scripting_first_script_setting_texture.webp)
...
![godot-sprite-centered](/godot/img/scripting_first_script_centering_sprite.webp)
...
![godot-attach-script](/godot/img/scripting_first_script_attach_script.webp)
...
![godot-create-script](/godot/img/scripting_first_script_attach_node_script.webp)
...
![godot-hello-world](/godot/img/scripting_first_script_print_hello_world.webp)
...
![godot-icon-turning-in-place](/godot/img/scripting_first_script_godot_turning_in_place.webp)
...
![godot-icon-rotating-icon](/godot/img/scripting_first_script_rotating_godot.webp)
...
![godot-moving-with-input](/godot/img/scripting_first_script_moving_with_input.webp)
...
![godot-icon-moving-up](/godot/img/scripting_first_script_moving_with_input.webp)
...
1. Crea una nueva escena yendo al menú `Scene > New Scene`.
    ...
    ![new-scene](/godot/img/signals_01_new_scene.webp)

2. En el dock **Scene**, haz clic en el botón **2D Scene**. Esto agregará un _Node2D_ como raíz.

    ![2d-scene](/godot/img/signals_02_2d_scene.webp)
...
3. En el dock **FileSystem**, haz clic y arrastra el archivo `sprite_2d.tscn` que guardaste anteriormente sobre el _Node2D_ para crear una instancia del mismo.
    ...
    ![new-instance](/godot/img/signals_03_dragging_scene.webp)
...
4. Queremos agregar otro nodo como hermano del _Sprite2D_. Para hacerlo, haz clic derecho en **Node2D** y selecciona `Add Child Node`.
    ...
    ![add-child-node](/godot/img/signals_04_add_child_node.webp)

5. Busca el nodo `Button` y agrégalo.

    ![add-button](/godot/img/signals_05_add_button.webp)
...
6. De manera predeterminada el nodo es pequeño. Haz clic y arrastra el controlador inferior derecho del botón en la ventana gráfica para cambiar su tamaño:
    ...
    ![drag-button](/godot/img/signals_06_drag_button.webp)
...
10. Las señales pueden ser conectadas en el panel **Node**. ​​Seleccione el nodo `Button` y, en el lado derecho del editor, haga clic en la pestaña denominada **Node** junto al **Inspector**.
    ...
    ![select-tool](/godot/img/signals_10_node_dock.webp)
...
11. El dock muestra una _lista de señales disponibles_ para el nodo seleccionado. Haga doble clic en la señal `pressed()` para abrir la ventana `Connect a Signal to a Method`.
    ...
    ![select-tool](/godot/img/signals_11_pressed_signals.webp)
...
12. Aquí puedes conectar la señal al nodo `Sprite2D`. El nodo necesita un _método receptor_, una función que Godot llamará cuando el botón emita la señal. El editor genera uno para ti. Por convención, llamamos a estos métodos de devolución de llamada **_on_node_name_signal_name**. Aquí, será `_on_button_pressed`:
    ...
    ![select-tool](/godot/img/signals_12_node_connection.webp)
...
>
>    ![select-tool](/godot/img/signals_advanced_connection_window.webp)
>
...
13. Luego de seleccionar el nodo `Sprite2D`, clic en el botón `Connect` para completar la conexión de la señal y saltar al espacio de trabajo de **Script**. Deberías ver el nuevo método con un **ícono de conexión** en el margen izquierdo.
    ...
    ![select-tool](/godot/img/signals_13_signals_connection_icon.webp)
...
14. Si haces clic en el **ícono de conexión**, aparece la ventana **Connections to method** que muestra información sobre la conexión. Esta función solo está disponible cuando se conectan nodos en el editor.
    ...
    ![select-tool](/godot/img/signals_14_signals_connection_info.webp)
...
![click-script](/godot/img/signals_17_custom_signal.webp)
...
Para todos aquellos que son nuevos en la programación (o que no se sienten muy seguros pero quieren aprenderlo orientado a los videojuegos), recomendamos encarecidamente el curso gratuito de GDScript en 27 lecciones creado por GDQuest. Cubre los conceptos básicos de la programación y te prepara para crear juegos con Godot. Muy importante: el curso está en idioma _inglés_.
