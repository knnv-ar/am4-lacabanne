---
title: 'Capítulo 4:  Tu primer juego 3D'
description: 'Capítulo 4:  Tu primer juego 3D'
sidebar:
  order: 4
  hidden: false
---

> **Nota sobre la versión:** Este capítulo fue escrito y capturado con **Godot Engine v4.3**. La última versión estable es la **v4.7.2** y la interfaz del editor cambió de manera notoria desde entonces (tema nuevo, docks movibles, ventana de juego embebida). El código y los pasos siguen siendo válidos. Antes de empezar, leé el [Capítulo 5: De la v4.3 a la v4.7.2](/godot-engine/capitulo-5/), que resume qué cambió y qué esperar en pantalla.
...
![squash-the-creeps-final](/godot/img/squash-the-creeps-final.webp)
...
![01.import_button](/godot/img/01.import_button.webp)
...
![02.browse_to_project_folder](/godot/img/02.browse_to_project_folder.webp)

Haz clic en **Import & Edit** para abrir el proyecto en el editor.

![03.import_and_edit](/godot/img/03.import_and_edit.webp)
...
![import_project_to_4.x_prompt](/godot/img/import_project_to_4.x_prompt.webp)
...
![04.assets](/godot/img/04.assets.webp)
...
![adding_static_body3D](/godot/img/adding_static_body3D.webp)

Su árbol de escena debería verse así:

![06.staticbody_node](/godot/img/06.webp)
...
![07.collision_shape_warning](/godot/img/07.webp)
...
![08.create_box_shape3D](/godot/img/08.create_box_shape3D.jpg)
...
![08.box-size](/godot/img/09.box_size.webp)
...
![12.cube_resized](/godot/img/12.webp)
...
![use_snap](/godot/img/use_snap.webp)
...
![move_gizmo_y_axis](/godot/img/move_gizmo_y_axis.webp)
...
![move_gizmo_y_axis](/godot/img/14.webp)
...
![translation_amount](/godot/img/15.webp)
...
![ground_down1meter](/godot/img/ground_down1meter.webp)
...
![create_directional_light3d](/godot/img/create_directional_light3d.webp)
...
![16.turn_on_shadows](/godot/img/16.turn_on_shadows.webp)

En este punto, tu proyecto debería verse así:

![17.project_with_light](/godot/img/17.project_with_light.webp)
...
![01.new_scene](/godot/img/01.new_scene.png)

Crea un **CharacterBody3D** como nodo raíz:

![add_character_body3D](/godot/img/add_character_body3D.webp)
...
![add_capsuleshape3d](/godot/img/add_capsuleshape3d.webp)

La _estructura de alambre_ de la esfera aparece debajo del personaje.

![04.sphere_shape](/godot/img/04.sphere_shape.png)
...
![06.toggling_visibility](/godot/img/06.toggling_visibility.webp)
...
![07.project_settings](/godot/img/07.project_settings.png)
...
![07.adding_action](/godot/img/07.adding_action.webp)

Crea las siguientes cinco acciones:

![08.actions_list_empty](/godot/img/08.actions_list_empty.png)
...
![left_inputmap](/godot/img/left_inputmap.webp)

Vincula también la tecla **A** a la acción `move_left`.

![09](/godot/img/09.webp)
...
![joystick_axis_input](/godot/img/joystick_axis_input.webp)

Selecciona el _eje X negativo_ en el joystick izquierdo.

![left_joystick_select](/godot/img/left_joystick_select.webp)
...
![12.move_inputs_mapped](/godot/img/12.move_inputs_mapped.webp)

La última acción que debes configurar es la acción `jump`. Vincula la tecla **Space** y el botón **A** del gamepad.

![13.joy_button_option](/godot/img/13.joy_button_option.webp)

Tu acción de entrada de salto debería verse así:

![14.jump_input_action](/godot/img/14.jump_input_action.webp)
...
![01.attach_script_to_player](/godot/img/01.attach_script_to_player.webp)
...
![03.instance_child_scene](/godot/img/03.instance_child_scene.webp)
...
![04.scene_tree_with_camera](/godot/img/04.scene_tree_with_camera.webp)
...
![05-moving-player-code](/godot/img/05-moving-player-code.webp)
...
![12.viewport_change](/godot/img/12.viewport_change.webp)

![06-viewport](/godot/img/06-viewport.webp)
...
![07-perspective](/godot/img/07-perspective.webp)
...
![08-perspective-preview](/godot/img/08-perspective-preview.webp)
...
![09-perspective-preview-b](/godot/img/09-perspective-preview-b.webp)

Puedes ejecutar la escena presionando `F6` y las teclas flecha para mover el personaje.

![10-perspective-preview-c](/godot/img/10-perspective-preview-c.webp)
...
![13.camera3d_values](/godot/img/13.camera3d_values.webp)
...
![drag_drop_mob](/godot/img/drag_drop_mob.webp)

Puedes cambiar el nombre del nodo **mob** recién arrastrado a `Character`.

![01-mobs](/godot/img/01-mobs.webp)
...
![02-mobs](/godot/img/02-mobs.webp)

Agrega un **CollisionShape3D**.

![03-mobs](/godot/img/03-mobs.webp)
...
![05-mobs](/godot/img/05-mobs.webp)
...
![08-mobs](/godot/img/08-mobs.webp)
...
![09-mobs](/godot/img/09-mobs.webp)
...
![10.node_dock](/godot/img/10.node_dock.webp)

Conecta la señal a `Mob`

![11.connect_signal](/godot/img/11.connect_signal.webp)
...
![01-spawing-mobs](/godot/img/01-spawing-mobs.webp)
...
![02-spawing-mobs](/godot/img/02-spawing-mobs.webp)
...
![03.window_settings](/godot/img/03.window_settings.webp)
...
![04.camera_preview](/godot/img/04.camera_preview.png)
...
![05-spawning-mobs](/godot/img/05-spawning-mobs.webp)

En **Inspector**, asigne a la propiedad _Mesh_ el valor `New CylinderMesh`.

![06-spawning-mobs](/godot/img/06-spawning-mobs.webp)
...
![07-spawning-mobs](/godot/img/07-spawning-mobs.webp)
...
![08-spawning-mobs](/godot/img/08-spawning-mobs.webp)
...
![11-spawning-mobs](/godot/img/11-spawning-mobs.webp)

Muévelos hacia la derecha arrastrando el _eje X rojo_.

![12-spawning-mobs](/godot/img/12-spawning-mobs.webp)
...
![13-spawning-mobs](/godot/img/13-spawning-mobs.webp)

En _Inspector_, expanda la sección _Material_ y asigne un `New StandardMaterial3D` a la ranura `0`.

![14-spawning-mobs](/godot/img/14.multi_material_selection.webp)

![standard_material](/godot/img/standard_material.webp)
...
![albedo_section](/godot/img/albedo_section.webp)

Establezca el color en algo que contraste con el fondo, como un naranja brillante.

![15-spawning-mobs](/godot/img/15-spawning-mobs.webp)
...
![16-spawning-mobs](/godot/img/16-spawning-mobs.webp)
...
![17-spawning-mobs](/godot/img/17-spawning-mobs.webp)
...
![18-spawning-mobs](/godot/img/18-spawning-mobs.webp)

Su ruta debería verse así:

![19-spawning-mobs](/godot/img/19-spawning-mobs.webp)
...
![20-spawning-mobs](/godot/img/20-spawning-mobs.webp)
...
![21-spawning-mobs](/godot/img/21-spawning-mobs.webp)

Agrega un nuevo nodo **Timer** como hijo de `Main`. Nómbralo `MobTimer`.

![22-spawning-mobs](/godot/img/22-spawning-mobs.webp)
...
![23-spawning-mobs](/godot/img/23-spawning-mobs.webp)
...
![24-spawning-mobs](/godot/img/24-spawning-mobs.webp)

Conéctalo al nodo `Main`.

![24.connect_timer_to_main](/godot/img/24.connect_timer_to_main.webp)
...
![25-spawning-mobs](/godot/img/25-spawning-mobs.webp)
...
![02-jumping-squashing-mobs](/godot/img/02-jumping-squashing-mobs.webp)
...
![03.physics_layers](/godot/img/03.physics_layers.webp)
...
![04.default_physics_properties](/godot/img/04.default_physics_properties.webp)
...
![05.toggle_layer_and_mask](/godot/img/05.toggle_layer_and_mask.webp)
...
![06-jumping-squashing-mobs](/godot/img/06-jumping-squashing-mobs.webp)
...
![07.player_physics_mask](/godot/img/07.player_physics_mask.webp)
...
![08.mob_physics_mask](/godot/img/08.mob_physics_mask.webp)
...
![09-jumping-squashing-mobs](/godot/img/mob_group.png)

Aparece un ícono en el dock _Scene_ para indicar que el nodo es parte de al menos un grupo.

![10-jumping-squashing-mobs](/godot/img/10-jumping-squashing-mobs.webp)
...
![01-killing-player](/godot/img/01-killing-player.webp)

En **Inspector**, asígnale un `New CylinderShape`.

![02-killing-player](/godot/img/02-killing-player.webp)
...
![03.cylinder_in_editor](/godot/img/03.cylinder_in_editor.png)
...
![04.mob_detector_properties](/godot/img/04.mob_detector_properties.webp)
...
![05-killing-player](/godot/img/05-killing-player.webp)
...
![06-killing-player](/godot/img/06-killing-player.webp)
...
![01-score-replay](/godot/img/01-score-replay.webp)

En **Inspector**, configure _Text_ del campo _Label_ con un placeholder como: `Score: 0`.

![02-score-replay](/godot/img/02-score-replay.webp)
...
![05-score-replay](/godot/img/05-score-replay.webp)
...
![06-score-replay](/godot/img/06-score-replay.webp)
...
![07-score-replay](/godot/img/07-score-replay.webp)
...
![08-score-replay](/godot/img/08-score-replay.webp)
...
![09-score-replay](/godot/img/09-score-replay.webp)
...
![13-score-replay](/godot/img/13-score-replay.webp)
...
![14-score-replay](/godot/img/14-score-replay.webp)
...
![17-score-replay](/godot/img/17-score-replay.png)
...
![18-score-replay](/godot/img/18-score-replay.webp)
...
![19-score-replay](/godot/img/19-score-replay.webp)
...
![20-score-replay](/godot/img/20-score-replay.webp)
...
![01-character-animation](/godot/img/01-character-animation.webp)
...
![02-character-animation](/godot/img/02-character-animation.webp)
...
![03-character-animation](/godot/img/03-character-animation.webp)

Nombra la animación `float`:

![04-character-animation](/godot/img/04-character-animation.webp)

Una vez que hayas creado la animación, aparecerá la _línea de tiempo_ con números que representan el tiempo en segundos.

![05-character-animation](/godot/img/05-character-animation.webp)

Queremos que la animación comience a reproducirse automáticamente al comienzo del juego. Además, debería repetirse.

Para ello, puedes hacer clic en el botón _reproducción automática_ (Autoplay: ![autoplay_button](/godot/img/autoplay_button.webp)) en la barra de herramientas de animación, y clic en las _flechas de repetición_, respectivamente.

![06-character-animation](/godot/img/06-character-animation.webp)
...
![07-character-animation](/godot/img/07-character-animation.webp)

Establece la _duración de la animación_ en `1.2` segundos en la parte superior derecha del dock.

![08-character-animation](/godot/img/08-character-animation.webp)
...
![09-character-animation](/godot/img/09-character-animation.webp)
...
![10-character-animation](/godot/img/10-character-animation.webp)
...
![11-character-animation](/godot/img/11-character-animation.webp)

![12-character-animation](/godot/img/12-character-animation.webp)
...
![13-character-animation](/godot/img/13-character-animation.webp)
...
![14-character-animation](/godot/img/14-character-animation.webp)

Mueva el _cursor de tiempo_ a `0.5` segundos haciendo clic y arrastrando en la línea de tiempo gris.

![15-character-animation](/godot/img/15-character-animation.webp)
...
![16-character-animation](/godot/img/16-character-animation.webp)

Cree un _keyframe_ para ambas propiedades:

![17-character-animation](/godot/img/17-character-animation.webp)

Ahora, mueva el _keyframe_ de _Position_ a `0.7` segundos arrastrándolo en la línea de tiempo.

![18-character-animation](/godot/img/18-character-animation.webp)
...
![19-character-animation](/godot/img/19-character-animation.webp)
...
![20-character-animation](/godot/img/20-character-animation.webp)
...
![21-character-animation](/godot/img/21-character-animation.webp)

Puede editar simultáneamente las propiedades de ambas claves en _Inspector_, donde puede ver una propiedad _Easing_.

![22-character-animation](/godot/img/22-character-animation.webp)
...
![23-character-animation](/godot/img/23-character-animation.webp)
...
![24-character-animation](/godot/img/24-character-animation.webp)

Haz lo opuesto para el segundo keyframe de _posición_, arrastrándolo hacia la derecha.

![25-character-animation](/godot/img/25-character-animation.webp)

Tu animación debería verse así:

![26-character-animation](/godot/img/26-character-animation.gif)
...
![27-character-animation](/godot/img/27-character-animation.webp)
...
A continuación, asegúrate de que el botón _reproducción automática_ (Autoplay: [autoplay_button](/godot/img/autoplay_button.webp)) y las flechas de bucle (Animation looping) también estén activados en el editor de animación del panel inferior. Eso es todo; todos los _mobs_ reproducirán ahora la animación _float_.
