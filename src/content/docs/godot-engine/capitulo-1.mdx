---
title: 'Capítulo 1: Introducción a Godot Engine v4.3'
description: 'Capítulo 1: Introducción a Godot Engine v4.3'
sidebar:
  order: 1
  hidden: false
---
...
![godot-nodes](/godot/img/key_concepts_character_nodes.webp)
...
![godot-signals](/godot/img/key_concepts_signals.webp)
...
![godot-project-manager](/godot/img/editor_intro_project_manager.webp)
...
![godot-project-templates](/godot/img/editor_intro_project_templates.webp)

La configuración del `Project Manager` se puede abrir mediante el menú `Settings`:

![godot-settings](/godot/img/editor_intro_settings.webp)
...
![godot-editor](/godot/img/editor_intro_editor_empty.webp)
...
![godot-top-menus](/godot/img/editor_intro_top_menus.webp)
...
![godot-scene-selector](/godot/img/editor_intro_scene_selector.webp)
...
![godot-3D-viewport](/godot/img/editor_intro_3d_viewport.webp)

Esta `toolbar` cambia según el contexto y el nodo seleccionado. Aquí está la barra de herramientas 2D:

![godot-2D-toolbar](/godot/img/editor_intro_toolbar_2d.webp)

A continuación se muestra la barra de herramientas 3D:

![godot-3D-toolbar](/godot/img/editor_intro_toolbar_3d.webp)
...
![godot-filesystem-dock](/godot/img/editor_intro_filesystem_dock.webp)

El dock `Scene` (Escena) muestra una lista de los nodos de la escena activa:

![godot-scene-dock](/godot/img/editor_intro_scene_dock.webp)

El dock `Inspector` le permite editar las propiedades de un nodo seleccionado:

![godot-inspector-dock](/godot/img/editor_intro_inspector_dock.webp)
...
![godot-bottom-panel](/godot/img/editor_intro_bottom_panels.webp)

Al hacer clic en uno, se expande verticalmente. A continuación, puedes ver el editor de animaciones abierto:

![godot-bottom-panel-animation](/godot/img/editor_intro_bottom_panel_animation.webp)
...
![godot-2D](/godot/img/editor_intro_workspace_2d.webp)

En la `3D screen`, puedes trabajar con meshes (mallas), luces y niveles de diseño para juegos 3D.

![godot-3D](/godot/img/editor_intro_workspace_3d.webp)
...
![godot-script](/godot/img/editor_intro_workspace_script.webp)
...
![godot-asset-library](/godot/img/editor_intro_workspace_assetlib.webp)
...
![godot-search-help-button](/godot/img/editor_intro_search_help_button.webp)
...
![godot-search-help](/godot/img/editor_intro_search_help.webp)

Haz doble clic en un elemento para abrir la página correspondiente en la pantalla principal del script.

![godot-help-class](/godot/img/editor_intro_help_class_animated_sprite.webp)
...
![godot-engine-design](/godot/img/engine_design_01.webp)
...
![godot-engine-design2](/godot/img/engine_design_02.webp)
...
!![godot-engine-design3](/godot/img/engine_design_03.webp)
...
![godot-state-machine-editor](/godot/img/engine_design_fsm_plugin.webp)
...
![godot-state-machine-editor](/godot/img/engine_design_rpg_in_a_box.webp)
